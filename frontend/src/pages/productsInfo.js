            ...
            <section className="page-section">
                <div className="container">
                    <div className="product-item">
                        ...
                        <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src={p1} alt="..." />
            ...
            <section className="page-section">
                <div className="container">
                    <div className="product-item">
                        ...
                        <img className="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src={p3} alt="..." />
                        <div className="product-item-description d-flex me-auto">
